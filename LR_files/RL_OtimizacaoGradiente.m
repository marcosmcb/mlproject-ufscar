function [RL_thetaOtimizado, RL_custoOtimizado] = RL_OtimizacaoGradiente( trainData, targetData , RL_lambda)
...
% Inicializa o parametro que sera ajustados
RL_theta_inicial = zeros(size(trainData, 2), 1);
...
% Otimiza o gradiente
[RL_thetaOtimizado, RL_custoOtimizado, ~, ~] = fminunc(@(t) ...
	(RL_funcaoCustoRegularizada(t, trainData, targetData, RL_lambda)), RL_theta_inicial, RL_opcoes);
