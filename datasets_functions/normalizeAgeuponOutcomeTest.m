function [ age_cells ] = normalizeAgeuponOutcomeTest( age_cells, biggestAge, smallestAge )
    ...
    age_cells = tokenizeAndMultiplyTest( age_cells, lengthArr, biggestAge, smallestAge );
