...
%  Function: normalizeAndCleanerBreedsAndColors
%  Help:
...
%  79 - 102 -   Color(properly)     (Vetor de Bits com 24 possiblidades);
%  103 - 114 -  Color(pattern)      (Vetor de Bits com 12 possiblidades);
%  115 - 119 -  Class(RESULT)       (Vetor de Bits com 5 possibilidades);
%
...
fprintf('Imprindo os dados em um arquivo: "datasetNormalAndCleanWithGroupOfBreedsAndColors.csv "...\n\n');
dlmwrite('../datasets_normal&clean/datasetNormalAndCleanWithGroupOfBreedsAndColors.csv',MATRIX);
